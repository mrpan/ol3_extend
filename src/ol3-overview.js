...
{	var options = opt_options || {};
	...
	{	
		 ...
		 // element.className= 'ol-overview ol-unselectable ol-control ol-collapsed'
		...
		// if (/top/.test(options.align)) element.className= 'ol-overview ol-unselectable ol-control ol-collapsed ol-control-top';
		if (/right/.test(options.align)) element.addClass('ol-control-right');
		// if (/right/.test(options.align)) element.className= 'ol-overview ol-unselectable ol-control ol-collapsed ol-control-right';
...
{   ol.control.Control.prototype.setMap.call(this, map);
	...
	if(center){//增加鹰眼中心初始化
		this.ovmap_.getView().setCenter(center);
	}
